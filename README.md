...
[![npm](https://img.shields.io/npm/v/@devtea2027/quidem-id-in-perferendis.svg)](https://www.npmjs.com/package/@devtea2027/quidem-id-in-perferendis)
[![downloads](https://img.shields.io/npm/dt/@devtea2027/quidem-id-in-perferendis.svg)](https://www.npmjs.com/package/@devtea2027/quidem-id-in-perferendis)
[![types](https://img.shields.io/npm/types/@devtea2027/quidem-id-in-perferendis.svg)](https://www.npmjs.com/package/@devtea2027/quidem-id-in-perferendis)
[![licence](https://img.shields.io/github/license/mnasyrov/@devtea2027/quidem-id-in-perferendis.svg)](https://github.com/devtea2027/quidem-id-in-perferendis/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@devtea2027/quidem-id-in-perferendis/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@devtea2027/quidem-id-in-perferendis?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@devtea2027/quidem-id-in-perferendis**][@devtea2027/quidem-id-in-perferendis/docs]             | Core elements, state and effect management | [Docs][@devtea2027/quidem-id-in-perferendis/docs], [API][@devtea2027/quidem-id-in-perferendis/api]             |
| [**@devtea2027/quidem-id-in-perferendis-react**][@devtea2027/quidem-id-in-perferendis-react/docs] | Tooling for React.js                       | [Docs][@devtea2027/quidem-id-in-perferendis-react/docs], [API][@devtea2027/quidem-id-in-perferendis-react/api] |
...
```
npm install @devtea2027/quidem-id-in-perferendis @devtea2027/quidem-id-in-perferendis-react --save
```
...
import {
  ...
  Query,
  withStoreUpdates,
} from '@devtea2027/quidem-id-in-perferendis';
...
import { useConst, useObservable, useQuery } from '@devtea2027/quidem-id-in-perferendis-react';
...
[@devtea2027/quidem-id-in-perferendis/docs]: packages/@devtea2027/quidem-id-in-perferendis/README.md
[@devtea2027/quidem-id-in-perferendis/api]: packages/@devtea2027/quidem-id-in-perferendis/docs/README.md
[@devtea2027/quidem-id-in-perferendis-react/docs]: packages/@devtea2027/quidem-id-in-perferendis-react/README.md
[@devtea2027/quidem-id-in-perferendis-react/api]: packages/@devtea2027/quidem-id-in-perferendis-react/docs/README.md
